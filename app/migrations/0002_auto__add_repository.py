...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_repository', (
            ...
            ('source_type', self.gf('django.db.models.fields.CharField')(default='svn', max_length=255)),
        ))
        db.send_create_signal('app', ['Repository'])


    def backwards(self, orm):
        # Deleting model 'Repository'
        db.delete_table('app_repository')
